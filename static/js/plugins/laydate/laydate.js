/*! laydate-v5.0.6 日期与时间组件 MIT License  http://www.layui.com/laydate/  By 贤心 */
;!function () {
    "use strict";
    ...
    C.prototype = [], C.prototype.constructor = C, w.extend = function () {
        ...
        e.remove(T.thisElem), a ? t.elem.append(i) : (document.body.appendChild(i), e.position()), e.checkDate().calendar(), e.changeEvent(), T.thisElem = e.elemID, "function" == typeof t.ready && t.ready(w.extend({}, t.dateTime, {month: t.dateTime.month + 1}))
